...
import { View, Text, FlatList, Dimensions, PanResponder, TouchableOpacity, Image } from 'react-native';
import {
  // getDay,
  format,
  addDays,
  ...
  render() {
    ...
    return (
      <View style={styles.itemContainer}>
        <TouchableOpacity underlayColor='#008b8b' style={styles.itemWrapButton} onPress={onItemPress}>
          <View
            style={[
              styles.itemView,
              {
...
class CalendarStrip extends Component {
  ...
  render() {
    const { markedDate, onPressDate, selectedDate, showChineseLunar } = this.props;
    const marked = markedDate.map((ds) => this.stringToDate(ds));
    ...
    return (
      <View style={styles.container} {...this.panResponder.panHandlers}>
        ...
        <View style={styles.ctCalendar}>
          <TouchableOpacity onPress={this.onNext} style={styles.ctNext}>
            <Image source={require('../icon/arrow_left.png')} />
          </TouchableOpacity>
          <FlatList
            ref={(ref) => {
              this.calendar = ref;
          ...
          />
          <TouchableOpacity style={styles.ctNext}>
            <Image source={require('../icon/arrow_right.png')} />
          </TouchableOpacity>
        </View>
      </View>
    );
