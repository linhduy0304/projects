        ...
        <View style={styles.boxSimpleNews}>
          {
            ...
            <TouchableOpacity style={styles.infoNews} onPress= {(this.props.currentUser.skintest == this.props.feed.group.short_name || this.props.feed.group.type == 'public') ? () => null : null}>
                ...
                <View style={styles.colDescription}>
                  <View style={styles.contentNews}>
                    <Text numberOfLines={5} style= {styles.contentColor}>
                      <HTMLView html={this.props.feed.short_content}/>
                    </Text>
                  </View>
                </View>
              </View>
