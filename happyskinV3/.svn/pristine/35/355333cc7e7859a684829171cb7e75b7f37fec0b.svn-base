		        ...
		        <Animated.View style={[styles.container]}>
		          ...
		          >
		          	<View style={styles.boxThumbContent}>
			          	<View style={styles.boxContentIntroduce}>
			          		<Text style={styles.txtContentIntroduce}>{this.props.data.introduce}</Text>
			          	</View>
		          	...
		          	<View style={styles.boxSkinCoach}>
		          		<View style={styles.boxTopSkinCoach}>
	          				<Text style={styles.txtSkinCoach}>{'Coach by'.toUpperCase()}</Text>
		          		</View>
		          		<View style={styles.boxAuthor}>
		          			<View style={styles.avatar}>
		                  <Image source={{uri: this.props.data.author.avatar + '_100x100.png'}} style={styles.avatar_routine} />
		                </View>
		                <View style={styles.boxInfo}>
		                  <Text style={styles.txtUsername}>{this.props.data.author.full_name}</Text>
		          	...
		          	<View style={styles.boxProducts}>
		          		<View style={styles.boxTopReview}>
	          				<Text style={styles.txtSkinCoach}>{'ROUTINE DIARY'.toUpperCase()}</Text>
		          		</View>
	              ...
	              <View style={styles.boxReviews}>
		          		...
		          		<View style={styles.boxScoreReview}>
		          			<Text style={styles.txtScoreReview}>{this.props.data.raty_score}</Text>
		          			<Text style={styles.txtCountReview}>{this.props.data.raty_count} lượt đánh giá.</Text>
		          		</View>
		                  ...
		                  <View style={{flex: 0.075}}>
		        						<Text style={styles.txtRating}>{this.props.data.raty_1}</Text>
		        					</View>
		        					<View style={{flex: 0.645}}>
		          					<Slider
						              maximumValue={100}
						              minimumValue={0}
						              value={this.props.data.raty_1}
		                  ...
		                  <View style={{flex: 0.075}}>
		        						<Text style={styles.txtRating}>{this.props.data.raty_2}</Text>
		        					</View>
		        					<View style={{flex: 0.645}}>
		          					<Slider
						              maximumValue={100}
						              minimumValue={0}
						              value={this.props.data.raty_2}
						              minimumTrackTintColor="#FF7536"
						              maximumTrackTintColor="#E7E7F0"
						              thumbTintColor="#FF7536"
						              thumbStyle={{width: 0, height: 0}}
		                  ...
		                  <View style={{flex: 0.075}}>
		        						<Text style={styles.txtRating}>{this.props.data.raty_3}</Text>
		        					</View>
		        					<View style={{flex: 0.645}}>
		          					<Slider
						              maximumValue={100}
						              minimumValue={0}
						              value={this.props.data.raty_3}
						              minimumTrackTintColor="#FF7536"
						              maximumTrackTintColor="#E7E7F0"
						              thumbTintColor="#FF7536"
						              thumbStyle={{width: 0, height: 0}}
		                  ...
		                  <View style={{flex: 0.075}}>
		        						<Text style={styles.txtRating}>{this.props.data.raty_4}</Text>
		        					</View>
		        					<View style={{flex: 0.645}}>
		          					<Slider
						              maximumValue={100}
						              minimumValue={0}
						              value={this.props.data.raty_4}
						              minimumTrackTintColor="#FF7536"
						              maximumTrackTintColor="#E7E7F0"
						              thumbTintColor="#FF7536"
						              thumbStyle={{width: 0, height: 0}}
		                  ...
		                  <View style={{flex: 0.075}}>
		        						<Text style={styles.txtRating}>{this.props.data.raty_5}</Text>
		        					</View>
		        					<View style={{flex: 0.645}}>
		          					<Slider
						              maximumValue={100}
						              minimumValue={0}
						              value={this.props.data.raty_5}
						              minimumTrackTintColor="#FF7536"
						              maximumTrackTintColor="#E7E7F0"
						              thumbTintColor="#FF7536"
						              thumbStyle={{width: 0, height: 0}}
									...
									{
										this.props.data.user_raties.map((item, index) => {
											return (
