        ...
        <View style={main.container}>
          <ScrollView>
            <View style={styles.ctAvatar}>
              <Image style={{height: 124, width: 124, borderRadius: 62}} source={{uri: this.props.profile.otherProfile.avatar+'_100x100.png'}} />
            </View>
            <View style={styles.ctName}>
              <Text style={styles.txtName}>{this.props.profile.otherProfile.full_name}</Text>
              <View style={{flexDirection: 'row', marginTop: 5}}>
                <View style={styles.ctSkin}>
                  <Text style={styles.txtSkin}>{this.props.profile.otherProfile.skintest}</Text>
                </View>
              </View>
              <Text style={styles.txtLevel}>{this.props.profile.otherProfile.level ? this.props.profile.otherProfile.level.level_name : ''}</Text>
            </View>
            <View style={styles.ctContent}>
              <Text style={styles.txtInfo}>{this.props.profile.otherProfile.description}</Text>
