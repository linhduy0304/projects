  ...
  render() {
    return (
      <View style={styles.content}>
        <ImageBackground style={styles.background} source={require('../images/background_routine.png')}>
          <StatusBar
          ...
          <View style={styles.boxInfo}>
            ...
            <ImageBackground style={styles.image_thumb} source={require('../images/routine_done.png')}>
