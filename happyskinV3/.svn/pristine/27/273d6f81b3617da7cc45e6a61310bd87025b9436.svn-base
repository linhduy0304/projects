            ...
            <View style={styles.skinResult}>
                ...
                <View style={styles.boxDetail}>
                    <View style={styles.rowResult}>
                        ...
                        <Text style={styles.styleText}>{this.props.skintest.results.skinObject.od.skin}</Text>
                    </View>
                    <View style={styles.rowResult}>
                        <View style={styles.styleName}>
                        ...
                        <Text style={styles.styleText}>{this.props.skintest.results.skinObject.rs.skin}</Text>
                    </View>
                    <View style={styles.rowResult}>
                        <View style={styles.styleName}>
                        ...
                        <Text style={styles.styleText}>{this.props.skintest.results.skinObject.np.skin}</Text>
                    </View>
                    <View style={styles.rowResult}>
                        <View style={styles.styleName}>
                        ...
                        <Text style={styles.styleText}>{this.props.skintest.results.skinObject.tw.skin}</Text>
                    </View>
                </View>
                <Text style={styles.txtContent}>
                    <HTMLView
                      value={this.props.skintest.results ? this.props.skintest.results.skinDetail.general : '' }
                /></Text>
            </View>
        );
    }
                ...
                <View style={main.container}>
                    ...
                    <View style={{flex: 1}}>
                        <NavBar style={{navBar: main.navBarWhite, statusBar: main.statusBar}} statusBar={{barStyle: 'dark-content', backgroundColor: '#fff'}} >
                            ...
                            <TouchableOpacity onPress={() => Actions.homeNew({type: 'reset'})} style={{position: 'absolute', right: 0, padding: 15}}>
                                <Image style={{width: 20, height: 22}} source={require('../images/icons/ic_home_focus.png')} />
                            </TouchableOpacity>
                        </NavBar>
                        ...
                        {this.props.skintest.results ?
                            <ScrollView
                                ...
                                <View style={styles.headerProcess}>
                                    ...
                                    <TouchableOpacity onPress={() => Actions.pageSkinProduct({skintype: this.props.skintest.results.skinType}) } style={styles.boxSkintest}>
                                        <Text style={styles.txtRefresh}>Xem tất cả sản phẩm</Text>
                                    </TouchableOpacity>
