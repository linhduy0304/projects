...
export default class Timeline extends Component {
  ...
  _renderCircle(rowData, sectionID, rowID){
      ...
      switch(this.props.innerCircle){        
        ...
        case 'number':
          let textColor = {
            color: rowData.textColor?rowData.textColor:this.props.textColor?this.props.textColor:defaultTextColor,
            fontSize: rowData.fontSize?rowData.fontSize:this.props.fontSize?this.props.fontSize:defaultFontSize,
          }
          innerCircle = (<Text style={textColor}>{rowData.number}</Text>)
        break;
      }
      return (
