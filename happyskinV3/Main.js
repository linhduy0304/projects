...
import PageGroup from './src/containers/PageGroup';
import PageSkinProduct from './src/containers/PageSkinProduct';
            ...
            <Provider store={store}>
                <Router>
                    <Stack key="root">
                        ...
                        <Scene key="search"  keyword = 'a' panHandlers={null} component={Search} hideNavBar={true} />
                        ...
                        <Scene key="community" component={Community} hideNavBar={true}/>
                        <Scene key="pageGroup" component={PageGroup} hideNavBar={true}/>
                        <Scene key="pageSkinProduct" component={PageSkinProduct} hideNavBar={true}/>
                    </Stack>
                </Router>
            </Provider>
        );
