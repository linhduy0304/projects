...
class EditArticle extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      error: null,
      link: this.props.data.contentByUrls,
      paths: [],
      path: '',
      images: this.props.data.atributes,
      thumb: this.props.data.image_thumb,
      url_video: this.props.data.url_videos,
      video: '',
      pickThumb: null,
      pickImages: null,
      show: null
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            
            {
              ...
              <View style={styles.ctUrl}>
                ...
                <Text style={{color: 'rgb(51, 51, 51)', marginBottom: 5}}>Danh sách đường dẫn Youtube</Text>
                </View>
                {
            ...
            <View style={{flexDirection: 'row', marginTop: 15}} >
              ...
              {
                this.state.thumb ?
                  <Image style={{height:50, width: 50 }} source={this.state.pickThumb ? {uri: this.state.thumb} :{uri: this.state.thumb+ '_100x100.png'}} />
                : null
              }
              </View>
            ...
            <View style={{flexDirection: 'row', marginTop: 15}} >
                  ...
                  <ScrollView horizontal={true}>
                    {
                      this.state.images.map((item, index) => {
                        return (
                          <Image key={index} style={{height:50, width: 50, marginRight: 5}} source={this.state.pickImages ? {uri: item} : {uri: item.image_thumb + '_100x100.png'}} />
                        )
                      })
                    }
                  </ScrollView>
              ...
              <TouchableOpacity onPress={() => this.selectImage()} style={[styles.ctImage, {width: 150}]}>
                <Text style={{fontSize: 14, fontWeight: 'bold', color: '#fff'}}>Sửa ảnh đính kèm</Text>
              </TouchableOpacity>
            </View>
