...
class OtherPick extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      isRefreshing: false,
  ...
  loadMore() {
    if (!this.props.profile.lmOtherPick) {
        return;
    }
      ...
      <View style={css.container}>
        {
          ...
          :
          this.props.profile.otherPick ?
            this.props.profile.otherPick.length == 0 ?
            ...
            <FlatList
              ...
              data={this.props.profile.otherPick}
              refreshControl={
                <RefreshControl
...
export default connect(mapStateToProps, mapDispatchToProps)(OtherPick);