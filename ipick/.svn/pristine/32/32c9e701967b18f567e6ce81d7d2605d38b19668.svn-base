...
class CreateNewPass extends Component {
  ...
  save() {
    ...
    this.props.actions.createNewPass(body)
  }
        ...
        <NavBar style={{navBar: css.navBar, statusBar: css.statusBar}} statusBar={{barStyle: 'dark-content', backgroundColor: '#fff'}} >
          <NavGroup>
            ...
            <View style={{marginLeft: 9,justifyContent: 'center'}}>
              <Text style={css.txtTitle}>Cập nhật mật khẩu</Text>
            </View>
          </NavGroup>
        </NavBar>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateNewPass);
