...
class OtherProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if(nextProps.profile.otherCountPick !== null) {
      this.setState({
        allPicks: 'ALL PICKS' + ' ('+nextProps.profile.otherCountPick+')'
      })
    }
    if(nextProps.profile.otherCountPost !== null) {
      this.setState({
        myPicks: 'MY PICKS' + ' ('+nextProps.profile.otherCountPost+')'
      })
    }
  }
      ...
      <View style={css.container}>
        ...
        <View style={{flex: 1}}>
          ...
          <ScrollableTabView  renderTabBar={() => <ScrollableTabBar />}
            ...
            >
              <OtherPick id = {this.props.id} tabLabel={this.state.allPicks} />
              <OtherPost id={this.props.id} tabLabel={this.state.myPicks} />
