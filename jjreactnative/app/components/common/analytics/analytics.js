...
import {FbAppEventsLogger} from './facebook/facebook-analytics';
import {FirebaseAnalytics} from './firebase/firebase-analytics'
import {GAAnalytics} from './ga/ga-analytics'
import {List} from 'immutable'
import {fetcherConfig} from '../../../api/fetcher'
import {StringUtil} from '../../../utils/string-util'
import {ObjectUtil} from '../../../utils/object-utils'
import {InsiderAnalytics} from '../../../common/analytics/insider-analytics';
...
const AnalyticsUtil = {
    ...
    logCurrentScreen(name, params) {
        try {
            let loggingParams = {
                ...params,
                ...AnalyticsUtil.getTrackingSources()
            };
    ...
    logViewParentDealDetail(brandSlug, dealSlug, dealType) {
        try {
            const trackingSources = AnalyticsUtil.getTrackingSources();
