...
class TabEventToolbar extends BaseComponent {
    ...
    constructor(props) {
        super(props);
        this.initStatusBarBackground = props.headerColor;
    }


    render() {
        console.log('TabEventToolbar:render', this.props, this.initStatusBarBackground);
        return (
            <View
                style={{
                    width
                ...
                <JJStatusBar removeSetBackgroundColor={true}
                             styleColor={'dark'}/>
