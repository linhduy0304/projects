  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        {/* Title */}
        <HeaderSection title={'Menu'} onShowAll={this._goToAllStoreMenu} />
          ...
          {this.props.images
            ...
            .map((image, i) => {
              ...
              return (
                ...
                >
                  <TouchableOpacity
                    onPress={() => this._goToImageSlider(i)}
                  ...
                  >
                    ...
                    />
                    {i >= 4 && imageCount > 5 && (
                      <Text style={styles.textCount}>+{imageCount - 5}</Text>
                    )}
                  </TouchableOpacity>
                </View>
              );
        ...
        <View
          style={{
            ...
            height: DIMENSION_PADDING_LARGE
          }}
        />
      </View>
    );
