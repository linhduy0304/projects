...
import ButtonNonFillNormal from '../../common/view/button/ButtonNonFillNormal';
    ...
    render() {
        ...
        return (
            <View style={[styles.container]}>
                <Text style={styles.text}>{'Nơi xem lại khuyến mãi đã đánh dấu.\nCó rất nhiều khuyến mãi dành cho bạn,'}</Text>
                <Text style={styles.text}>
                    {'vui lòng chọn '}
                    <JJIcon name={'bookmark_o'} color={'#454545'} size={14} />
                    {' để đánh dấu.'}
                </Text>
                <FastImage
