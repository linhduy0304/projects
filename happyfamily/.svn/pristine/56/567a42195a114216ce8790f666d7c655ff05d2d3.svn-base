...
import RequestRelationship from './screens/family/RequestRelationship';
        ...
        <Provider store = {store}>
          <Router>
            <Scene key="root">
              ...
              <Scene key="requestRelationship" component={RequestRelationship} hideNavBar={true} panHandlers={null} />
            </Scene>
          </Router>
        </Provider>
      );
