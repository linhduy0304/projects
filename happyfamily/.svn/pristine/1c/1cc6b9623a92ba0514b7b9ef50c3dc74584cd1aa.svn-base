...
import AddIndividualStep1 from '../family/AddIndividualStep1';
        ...
        }
        {
          this.props.home.home ?
            this.props.home.home.length === 0 ?
              <HomeFirstLogin onPress={(request) => this.setState({'modalSelectRelationship' : true, request: request})} />
            : null
          : null
        }
      </View>
    ...
    return (
      <View style={styles.container}>
        ...
        <Modal 
          ...
          >
            <AddIndividualStep1 close={() => this.setState({modalSelectRelationship: false})} request={this.state.request} />
        </Modal>
