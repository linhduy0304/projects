...
export default function reducer(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case COMMENT_REQUEST:
      return state.setIn(['sendComment'], true).setIn(['commentSuccess'], null);
    ...
    case COMMENT_SUCCESS:
      ...
      return state.setIn(['sendComment'], null)
                  ...
                  .setIn(['commentSuccess'], true);

    case COMMENT_FAIL: 
      return state.setIn(['sendComment'], null)
                  .setIn(['commentSuccess'], null)
    ...
    case POST_DETAIL_REQUEST:
      return state.setIn(['loading'], true).setIn(['postDetail'], null);
