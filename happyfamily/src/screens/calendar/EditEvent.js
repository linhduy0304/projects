...
class EditEvent extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      typeEvent: {
        title: this.renderTitle(this.props.data.type_event),
        type: this.props.data.type_event,
      },
      typeRemind: this.props.data.time_reminds,
      arrType: this.renderArr(this.props.data.time_reminds),
      typeCalendar: this.props.data.type_time,  //0: âm, 1: dương
    }
  }
  ...
  addEvent() {
    ...
    this.props.editEvent(body, this.props.data.slug);
  }
      ...
      <View style={styles.container}>
        ...
        <NavBar style={{navBar: css.navBar, statusBar: css.statusBar}} statusBar={{barStyle: 'light-content', backgroundColor: '#C6247D'}} >
          ...
          <NavTitle style={css.navTitle}>
            <Text style={css.txtTitle}>Chỉnh sửa {this.props.date}</Text>
          </NavTitle>
          <NavButton/>
              ...
              <View style={styles.ctCalendar}>
                <View style={{alignItems: 'center'}}>
                  <ButtonTypeCalendar
                    ...
                    fontWeight = '400'
                  />
                  <Text style={{color: '#000', marginTop: 5}}>( {this.props.lunar} )</Text>
                </View>
                <View style={{alignItems: 'center'}}>
                <ButtonTypeCalendar
                  title = 'Dương lịch'
                  ...
                  fontWeight = '400'
                />
                 <Text style={{color: '#000', marginTop: 5}}>( {this.props.date} )</Text>
                </View>
              </View>
              {
                this.props.calendar.loading ?
                <Loading title={'Đang sửa'}/>
                :
                <Button
...
const mapDispatchToProps = (dispatch) => {
  return {
    editEvent: (body, slug) => dispatch(editEvent(body, slug)),
  }
}
