...
(function() {
	...
	_chineseLunar.daysOfMonth = function(year, month, leap) {
		...
		return _chineseLunar.dateDiff(date1, date2, "d");
	...
	_chineseLunar.traditionalYearName = function(year) {
		var Gan = "Giáp,Ất,Bính,Đinh,Mậu,Kỷ,Canh,Tân,Nhâm,Quý".split(",");
		var Zhi = "Tý,Sửu,Dần,Mão,Thìn,Tỵ,Ngọ,Mùi,Thân,Dậu,Tuất,Hợi".split(",");
	...
	_chineseLunar.yearName = function(year) {
		var cnStr = "Canh,Tân,Nhâm,Quý,Giáp,Ất,Bính,Đinh,Mậu,Kỷ".split(",");
	...
	_chineseLunar.monthLable = function(month) {
